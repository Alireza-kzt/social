...
class _MessageFieldState extends State<MessageField> {
  ...
  void initState() {
    widget.controller.addListener(() {
      context.read<RecordAudioCubit>().toggleRecord(canRecord: widget.controller.text.isEmpty);
    });
    super.initState();
  }
        ...
        children: <Widget>[
          ...
          Expanded(
            child: ConstrainedBox(
              ...
              child: Padding(
                padding: widget.textPadding ?? const EdgeInsets.symmetric(horizontal: 8),
                child: TextField(
                  onTap: widget.onTap,
                  ...
                  maxLines: null,
                  onChanged: (s) {
                    context.read<RecordAudioCubit>().toggleRecord(canRecord: s.isEmpty);
                  },
